...
# GBM Model
```{r}
gbm.model <- h2o.gbm(y=target, x=predictor, training_frame = train.h2o, ntrees = 1500, max_depth = 4, learn_rate = 0.01, seed = 1122)
predict.gbm <- as.data.frame(h2o.predict(gbm.model, test.h2o))
```

```{r}
dlearning.model <- h2o.deeplearning(y = target,x = predictor,training_frame = train.h2o,epoch = 100,
